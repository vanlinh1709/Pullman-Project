...
function pdo_get_connection()
{
    ...
    try {
        $conn = new PDO("mysql:host=$servername;dbname=duan1_shop_db", $username, $password);
...
//Ham_thuc thi
/*Cac tham so truyen vao ham?
    tham_so_1: cau lenh sql
    tham_so_2,...tham_so_n: la nhung value truyen vao ? trong cau lenh sql
*/
